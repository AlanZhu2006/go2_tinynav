import os as _os
if _os.environ.get("TINYNAV_TORCH_MODELS") == "1":
    # x86 SIL fallback: same classes backed by torch (no .plan engines needed). See models_trt_torch.
    from tinynav.core.models_trt_torch import (SuperPointTRT, LightGlueTRT, Dinov2TRT,
                                               FoundationStereoTRT, RetinifyTRT)  # noqa: F401
else:
